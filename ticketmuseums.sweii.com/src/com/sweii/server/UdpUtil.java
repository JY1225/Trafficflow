...
public class UdpUtil {
	public static void main(String[] args) throws Exception{//a701  /01a7
	    ...
	    System.out.println(UdpUtil.toHex(13+11,16));
	}
	/**
	 * 校验和,长度为60
	 * @author duncan
	...
	public static String toHex(Integer id,Integer tix){
		String key= Integer.toString(id, tix);
		if(key.length()==1){
