...
public class StringUtil {
	...
	public static boolean isEmail(final String in){		
		if(StringUtil.isEmpty(in)) return false;
		int at = in.indexOf("@");
		int dot = in.indexOf(".");
	 ...
	 * @createTime 2011-4-5
	 */
	public static String toString(final double in){
...
//		if(StringHelper.parseInt(in, -999999) == -9999999)
		...
		String newDate = sdf.format(d).toString();
		System.out.println(newDate.substring(0, 10));
