...
<div class="box01" align="center"><span class="left">&nbsp;</span> <span class="tit" style="font-size: 20px"><b>收退押金统计表</b></span></div>
<center>
<div style="height:600px;overflow-y:scroll;overflow-x:hidden;overflow:scroll;">
<form action="/report/reportHandPrice.do" method="post" id="form">
...
<table  width="950px" style="font-size:12px">
    ...
    <table width="950px" border="0" cellspacing="0"  >
        <tr>
            ...
            <td align="center" width="50%" style="font-weight: bold; font-size: 25px">收退押金统计表</td>
        ...
        <tr>
            ...
            <table width="98%" border="0" cellspacing="0" class="table-border" style="height: 25px; text-align: left">
                <tr height="25px" style="font-weight: bold;font-size:12px;background-color: white">
                	...
                	<td align="center">收押金次数</td> 
                	<td align="center">押金总额</td> 
                	<td align="center">收租金总额</td> 
                	<td align="center">退押金次数</td>  
                ...
                <%
               	...
               	%>
               			 ...
               			 <tr height="25px" style="font-size:12px;background-color: white">
               				...
               				<td align="center"><%=NumbericHelper.getIntValue(tb.getPreCount(),0)%></td>
               				...
               				<td align="center"><%=NumbericHelper.getIntValue(tb.getBackCCount(),0)%></td>
		                    <td align="center"><%=NumbericHelper.getIntValue(tb.getBackCAmount(),0)%></td>
               				<td align="center"><%=NumbericHelper.getIntValue(tb.getPreAmount(),0)+NumbericHelper.getIntValue(tb.getAddAmount(),0)-NumbericHelper.getIntValue(tb.getBackCAmount(),0)%></td>
		                </tr>
                <%}%>
                <tr height="25px" style="font-size:12px;background-color: white">
               		<td align="center" style='color:red;font-weight:bold'>合计:</td> 
               		<td align="center" style='color:red;font-weight:bold'><%=NumbericHelper.getIntValue(cbean.getPreCount(),0)%></td>
              		<td align="center" style='color:red;font-weight:bold'><%=NumbericHelper.getIntValue(cbean.getPreAmount(),0)%></td>
              		<td align="center" style='color:red;font-weight:bold'><%=NumbericHelper.getIntValue(cbean.getAddAmount(),0)%></td>
              		 <td align="center" style='color:red;font-weight:bold'><%=NumbericHelper.getIntValue(cbean.getBackCCount(),0)%></td>
	                <td align="center" style='color:red;font-weight:bold'><%=NumbericHelper.getIntValue(cbean.getBackCAmount(),0)%></td>
              		<td align="center" style='color:red;font-weight:bold' ><%=NumbericHelper.getIntValue(cbean.getPreAmount(),0)+NumbericHelper.getIntValue(cbean.getAddAmount(),0)-NumbericHelper.getIntValue(cbean.getBackCAmount(),0)%></td>
                </tr>
            </table>
            </span>
            </td>
