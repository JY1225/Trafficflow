...
<div class="box01" align="center"><span class="left">&nbsp;</span> <span class="tit" style="font-size: 20px"><b>团体预售统计表</b></span></div>
<center>
...
<table  width="950px" style="font-size:12px">
    <tr>
        ...
        <table>
            ...
            <td style='font-size:12px'>
            		<span style='display:none'>&nbsp;&nbsp;售票员编号：&nbsp;<input id="saleAdmin" name="saleAdmin" value="<s:property value="saleAdmin"/>" type="text" style="width: 150px" /></span>
    ...
    <table width="950px" border="0" cellspacing="0"  >
        <tr>
            ...
            <td align="center" width="50%" style="font-weight: bold; font-size: 25px">团体预售统计表</td>
            <td width="20%" style="font-weight: bold;font-size:12px" align="right"><a href="javascript:void(0);" onclick="printHA4('print');" class="printBtn"><img src="/Icons/icon013a1.gif" />打印</a><a href="javascript:void(0);" onclick="saveAsFile('print','团体预售统计表.xls');" class="printBtn"><img src="/Icons/icon018a7.gif" />导出</a></td>
        </tr>       
        <tr>
            ...
            <table width="98%" border="0" cellspacing="0" class="table-border" style="height: 25px; text-align: left"  style="table-layout: fixed;">
                <tr height="25px" style="font-weight: bold;font-size:12px;background-color: white">
                	<td align="center" style="width:80px">订单编号</td> 
                	<td align="center" style="width:150px">公司名称</td>   
                	<td align="center" style="width:150px">票种名称</td> 
                    <td align="center" style="width:120px">收款时间</td>
                     <td align="center" style="width:80px">收款人</td>                	
                	<td align="center" style="width:80px">票价</td>  
                	<td align="center" style="width:80px">人数</td>          
                ...
                <%} %>
                <tr height="25px" style="font-size:12px;background-color: white">
               				<td align="center" colspan="6" style="color:red;font-weight:bold;">合计:</td>
